...
/* The external variable "environ" contains the environment variables. */

extern char **environ;

/* This structure will contain our environment variables. The nomenclature follows that of 'man getenv'. */
...
/* Find the first equals sign ("=") in "s". Returns -1 if there is no equals sign in the string. */
